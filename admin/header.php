...
<head>
    ...
    <title>Document</title><link rel="stylesheet" href="../cssadmin/style.css">
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
</head>
<body>
    <div class="boxcenter">
        <div class="row bm headeradmin">
            <h1>
                ADMIN
            </h1>
        </div>
        <div class="row bm menu">
            <ul>
                ...
                <li><a href="index.php?act=addtt">tintuc</a></li>
            </ul>
        </div>